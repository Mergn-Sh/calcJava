enum RomanNum {
    ...
    XXXVI(36), XXXVII(37), XXXVIII(38), XXXIX(39), XXXX(40),
    XXXXI(41), XXXXII(42), XXXXIII(43), XXXXIV(44), XXXXV(45),
    XXXXVI(46), XXXXVII(47), XXXXVIII(48), XXXXIX(49), L(40),
    ...
    final private int tranArab;

    RomanNum(int tranArab){
        this.tranArab = tranArab;
    }

    public int getTranArab(){
        return tranArab;
    }
}
